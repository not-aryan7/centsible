  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#F5F7FA" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", gap: "16px", alignItems: "center" }}>
          ...
          <Link to="/register" style={{
            fontSize: "14px", padding: "10px 24px", backgroundColor: "#028090",
      ...
      <section style={{
        ...
        <h2 style={{ fontSize: "56px", fontWeight: 900, lineHeight: 1.1, marginBottom: "24px", color: "#1A1A2E" }}>
          Smart Budgeting.<br />
        ...
        <Link to="/register" style={{
          fontSize: "18px", padding: "16px 40px", backgroundColor: "#028090",
        ...
        <div style={{
          ...
          {[
            ...
            <div key={step.num} style={{ textAlign: "center" }}>
              <div style={{
                width: "60px", height: "60px", borderRadius: "50%", backgroundColor: "#028090",
